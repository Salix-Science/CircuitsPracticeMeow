...
// Signal to index.html that firebase.js has finished setting up window.DB,
// window.S, window.doLogin, window.doRegister, etc. The inline bootstrap
// script in index.html waits for this before loading the other JS files.
