      ...
      <div style="display:flex;align-items:center;gap:10px;flex-shrink:0">
        ...
        <div style="width:56px;height:56px;position:relative">
          <svg viewBox="0 0 36 36" style="width:100%;transform:rotate(-90deg)">
            ...
            <circle cx="18" cy="18" r="15.9" fill="none" stroke="${p===100?'var(--green)':'var(--accent)'}" stroke-width="3"
              stroke-dasharray="${p} ${100-p}" stroke-linecap="round"/>
          </svg>
          <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-family:var(--mono);font-size:11px;font-weight:600;color:var(--text)">${p}%</div>
        </div>
      </div>
    </div>`;
